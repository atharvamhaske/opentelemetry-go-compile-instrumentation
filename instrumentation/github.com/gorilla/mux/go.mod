module go.opentelemetry.io/otelc/instrumentation/github.com/gorilla/mux

go 1.25.0

replace (
	go.opentelemetry.io/otelc/instrumentation => ../../..
...
require (
	...
	go.opentelemetry.io/otelc/instrumentation v0.0.0-20260903091335-1ff9e49ff4a9
